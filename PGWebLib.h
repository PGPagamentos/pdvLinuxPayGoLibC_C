/*********************** SETIS - Automação e Sistemas ************************
 ...
 02/Dez/20 Guilherme    - Adicionado PWINFO_SELFATT (CA20-0172).
 \*****************************************************************************/
...
enum{
   ...
   PWRET_PPS_ERRMAXAID = PWRET_PPS_MAX - 78,
   PWRET_PPS_INVAMOUNT,
   ...
   PWRET_PPS_RSPOVRFL = PWRET_PPS_MAX - 45,
   PWRET_PPS_PINBUSY,
   PWRET_PPS_NOCARD,
   PWRET_PPS_ERRPIN,
   PWRET_PPS_MCDATAERR,
